...
public class AmountView extends LinearLayout implements View.OnClickListener, TextWatcher {
    ...
    public AmountView(Context context, AttributeSet attrs) {
        ...
        int btnWidth = obtainStyledAttributes.getDimensionPixelSize(R.styleable.AmountView_btnWidth, 50);
        int tvWidth = obtainStyledAttributes.getDimensionPixelSize(R.styleable.AmountView_tvWidth, 50);
        int tvTextSize = obtainStyledAttributes.getDimensionPixelSize(R.styleable.AmountView_tvTextSize, 10);
