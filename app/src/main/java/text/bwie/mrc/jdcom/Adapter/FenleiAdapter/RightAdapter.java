...
import text.bwie.mrc.jdcom.ViewActivity.GoodInfoActivity;
...
public class RightAdapter extends BaseExpandableListAdapter{
  ...
  //          view = inflater.inflate(R.layout.elv_item1,null);
            view = View.inflate(context,R.layout.elv_item1,null);
 ...
 //           view = inflater.inflate(R.layout.elv_item2, null);
            view = View.inflate(context,R.layout.elv_item2,null);
        ...
        elvRvAdapter.setOnItemClickListener(new ElvRvAdapter.ItemOnclick() {
            @Override
            public void onItemClick(View v, int pcid) {
                Toast.makeText(context,pcid+"",Toast.LENGTH_SHORT).show();
                Intent intent=new Intent(context, GoodInfoActivity.class);
                intent.putExtra("pscid",pcid+"");
